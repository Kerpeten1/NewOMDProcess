...
__all__ = [ 'vbextFileTypeExe', 'CommandBarEvents', 'References',
           'vbext_vm_Break', '_VBComponent', '_ProjectTemplate',
           'vbext_pt_StandAlone', 'vbextFileTypeDesigners',
           'vbext_pp_locked', '_CommandBarControlEvents',
           'vbextFileTypePropertyPage', 'vbext_wt_Watch',
           'vbext_wt_Find', 'vbext_VBAMode', 'vbext_pk_Proc',
           'VBComponents', '_dispReferences_Events',
           'vbext_ct_StdModule', '_CodePane', '_dispVBProjectsEvents',
           'vbext_ct_ClassModule', 'vbext_cv_ProcedureView',
           'vbextFileTypeClass', 'vbextFileTypeProject',
           'vbext_wt_Toolbox', 'Component', '_Components',
           'Properties', 'vbext_wt_ToolWindow', '_AddIns',
           'vbext_pk_Get', 'Window', 'vbext_wt_Designer',
           'vbextFileTypeUserControl', '_VBComponents',
           'vbext_wt_PropertyWindow', '_VBProjects',
           'vbext_wt_Locals', '_VBProject_Old', 'LinkedWindows',
           '_VBProject', 'vbext_ComponentType', 'vbextFileTypes',
           'vbext_cv_FullModuleView', 'vbext_ct_Document',
           '_VBComponentsEvents', 'vbext_ProcKind', 'Reference',
           'vbext_ct_ActiveXDesigner', 'vbextFileTypeModule',
           'vbextFileTypeFrx', 'Addins', 'Windows', '_CodePanes',
           'Application', 'vbext_wt_Immediate', 'vbext_ws_Maximize',
           '_dispVBComponentsEvents', 'vbext_ws_Minimize',
           'VBProject', 'vbext_ct_MSForm', 'CodePane',
           'vbext_wt_ProjectWindow', 'vbextFileTypeRes', 'VBE',
           'Events', 'vbextFileTypeForm', 'vbext_ProjectProtection',
           'vbext_wt_MainWindow', 'Property', 'vbext_WindowType',
           'vbext_CodePaneview', '_dispCommandBarControlEvents',
           'vbext_RefKind', 'CodePanes', '_VBProjectsEvents',
           'VBProjects', '_Properties', 'vbext_wt_Browser',
           'vbext_wt_LinkedWindowFrame', '_dispReferencesEvents',
           '_References', '_CodeModule', '_Component',
           '_ReferencesEvents', 'vbext_ProjectType',
           'vbext_wt_CodeWindow', 'vbextFileTypeDocObject',
           'CodeModule', '_VBProjects_Old', 'AddIn',
           'ReferencesEvents', 'vbext_pk_Let', '_Windows',
           '_VBComponent_Old', 'vbext_pp_none', 'ProjectTemplate',
           'vbextFileTypeGroupProject', 'vbext_vm_Design',
           'vbext_wt_FindReplace', 'vbext_WindowState',
           '_LinkedWindows', '_Windows_old', 'VBComponent',
           'vbextFileTypeBinary', 'vbext_pt_HostProject',
           'Components', '_VBComponents_Old', 'SelectedComponents',
           'vbext_ws_Normal', 'vbext_pk_Set', 'vbext_vm_Run',
