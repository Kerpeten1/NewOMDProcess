...
IFontDisp = Font
__all__ = [ 'OLE_XPOS_PIXELS', 'OLE_XSIZE_CONTAINER', 'FONTSIZE',
           'FONTUNDERSCORE', 'Font', 'OLE_XPOS_HIMETRIC',
           'OLE_YSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS',
           'OLE_XPOS_CONTAINER', 'OLE_XSIZE_PIXELS', 'Default',
           'IPictureDisp', 'IFont', 'FONTSTRIKETHROUGH',
           'OLE_TRISTATE', 'OLE_ENABLEDEFAULTBOOL', 'Monochrome',
           'Picture', 'LoadPictureConstants', 'FONTBOLD', 'OLE_COLOR',
           'FONTITALIC', 'Gray', 'VgaColor', 'IFontEventsDisp',
           'FontEvents', 'StdPicture', 'OLE_YPOS_CONTAINER',
           'OLE_YSIZE_CONTAINER', 'Checked', 'IPicture',
           'OLE_OPTEXCLUSIVE', 'OLE_YPOS_PIXELS', 'StdFont',
           'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC', 'IFontDisp',
           'OLE_CANCELBOOL', 'Color', 'Unchecked', 'OLE_HANDLE',
           'FONTNAME']
