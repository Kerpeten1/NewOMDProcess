...
def save_omd_as_docx(company_name):
    document = Document("OMDLetter\OMD Vorlage\TCUST_standard_disclosure_letter_company_and_items_filled.docx")
...
def generate_docx_name(company_name, country, omd, todays_date, docx):
    ...
    all_file_names = next(os.walk("OMDLetter\Fertige OMDs\\"))[2]
